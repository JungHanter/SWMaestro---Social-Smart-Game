...
enum TextureOrder { ORDER_FARAWAY_MOUNTAIN=0, ORDER_FARAWAY_CLOUD, ORDER_FARWAY_CASTLE,
    ORDER_BACKGROUND, ORDER_BACKGROUND_OVERLAY, ORDER_OBJECT, ORDER_MONSTER, ORDER_HERO, ORDER_MENU };
...
enum INK_DIV_AMNOUT { INK_DIV_1=100, INK_DIV_2=300, INK_DIV_3=700, INK_DIV_4=1500 };
